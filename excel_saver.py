...
def save_xlsx_match_details(matchs_details, path='matchs_'):
    ...
    for matchs_details in matchs_details:
        ...
        col += 1
        worksheet.write(row, col, matchs_details['ID1'])
        col += 1
        worksheet.write(row, col, matchs_details['team2'])
        col += 1
        worksheet.write(row, col, matchs_details['ID2'])
        col += 1
        ...
        for odd in matchs_details['odds_total']:
            # print(odd)
            if odd['bookmaker'] == '1xStavka.ru':
                worksheet.write(row, 9, odd['coeff_over'])
                # col += 1
            elif odd['bookmaker'] == 'Parimatch.ru':
                worksheet.write(row, 10, odd['coeff_over'])
            elif odd['bookmaker'] == 'Leon.ru':
                worksheet.write(row, 11, odd['coeff_over'])
            elif odd['bookmaker'] == 'Olimp':
                worksheet.write(row, 12, odd['coeff_over'])
            elif odd['bookmaker'] == 'Winline.ru':
                worksheet.write(row, 13, odd['coeff_over'])
            elif odd['bookmaker'] == 'Leon.ru':
                worksheet.write(row, 14, odd['coeff_over'])
            elif odd['bookmaker'] == 'Fonbet':
                worksheet.write(row, 15, odd['coeff_over'])
            # else:
...
def save_xlsx_teams(links_to_matches, path='teams_'):
    ...
    for link in links_to_matches:
        ...
        col += 1
        worksheet.write(row, col, link['id'])
        col += 1
